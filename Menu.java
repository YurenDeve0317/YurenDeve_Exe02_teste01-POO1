...
public class Menu {
    ...
    public Menu() {
        ...
        int opcao;
        char resp = ' ';
        System.out.println("BEM-VINDO AO 3 LANCHES(YUDE)\n");
        String nome = vd.validarString("Insira o seu nome: ");
        do {
            System.out.println("""
    ...
    public void pagamentoFinal(float pagamento) {
        System.out.println("VALOR TOTAL: " + pagamento + " MT");
        float pagar = vd.validarFloat(pagamento, 10000, "QUANTO A PAGAR: ");
